...
package com.xing.module.quality.view.numberbutton;
...
//    }
    ...
    private void init(Context context, AttributeSet attrs) {
        LayoutInflater.from(context).inflate(R.layout.layout_numberbutton, this);
     ...
     * 添加监听，当等于1时，还去减少
     */
    private void warningForZero() {
        if (mOnWarnListener != null) mOnWarnListener.onWarningForZero();
    }
    ...
    public NumberButton setCurrentNumber(int currentNumber) {
        if (currentNumber < min) mCount.setText("" + min);
