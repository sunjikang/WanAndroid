...
import com.xing.manage.R;
 import com.xing.manage.adapter.manage.RunningAdapter;
 import com.xing.manage.bean.ProcessNodeVo;
import com.xing.manage.bean.manage.RunningBean;
 import com.xing.manage.contract.RunningContract;
 import com.xing.manage.presenter.RunningPresenter;

import java.util.ArrayList;
import java.util.List;

public class RunningFragment extends BaseMVPFragment<RunningPresenter> implements RunningContract.View, View.OnClickListener {

    private RecyclerView recyclerView;
    private ArrayList<RunningBean> dataList = new ArrayList<RunningBean>();
    ...
    @Override
    protected RunningPresenter createPresenter() {
    ...
    @Override
    public void onList(final List<RunningBean> doneBeanList) {
        {
            ...
            if (adapter == null) {
                adapter = new RunningAdapter(R.layout.item_manage_running, dataList);
            ...
            adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
                ...
                public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                    RunningBean result = dataList.get(position);
                    if (view.getId() == R.id.btn_suspend) {
                        ...
                        ARouter.getInstance()
                                ...
                                .withString("procInstId", result.getProcInstId())
                                .navigation();
                ...
                private void showDialog(RunningBean result, int i) {
