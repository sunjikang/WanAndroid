...
public class DeviceInspectionAdapter extends BaseQuickAdapter<Inspection, BaseViewHolder> {
    ...
    public DeviceInspectionAdapter(int layoutResId, @Nullable List<Inspection> data) {
    ...
    protected void convert(BaseViewHolder helper, Inspection item) {
        ...
        helper.setText(R.id.textView, item.inspectionItemName)
                .setText(R.id.textView12, "" + item.inspectionItemName)
                .setText(R.id.textView9, "" + item.id)
